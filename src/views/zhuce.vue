        ...
        <form name="form1" method="post" οnsubmit="return check()">
            <table>
                <tr> 
                    <td>用户名： </td> 
                    <td> 
                        <input id="text1" type="text" name="text1" οnblur="check()" class="input"> 
                ...
                <tr> 
                    <td>密码： </td> 
                    <td> 
                        <input id="text2" type="password" name="text2" οnblur="check()" class="input"> 
                ...
                <tr> 
                    <td>确认密码： </td> 
                    <td> 
                        <input id="text3" type="password" name="text3" οnblur="check()" class="input"> 
                        <div id="div3" style="display:inline"></div> 
                    </td> 
                </tr>
                <tr align="center"> 
                    <td align="center"> 
                        <input type="submit" value="提交" name="tect6"  @click="tijiao()">
