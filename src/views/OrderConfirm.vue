      ...
      <div class="checkout-order">
        ...
        <div class="item-list-wrap confirm-item-list-wrap">
          <div class="cart-item order-item">
            ...
            <ul
              ...
              v-bind:key="index"
            >
              <li v-if="item.checked == '1'" style="height:150px">
                <div class="cart-tab-1">
                  <div class="cart-item-pic">
                    <img
                      v-lazy="require('/src/assets/' + item.productImage)"
        ...
        <div class="order-foot-wrap">
          ...
          <div class="next-btn-wrap">
            <el-button type="text" @click="dialogVisible = true" class="zf"
              >支付</el-button
            >
            ...
            >
              <div class="zhifu">
                <img
                  src="../assets/zhifu.png"
                  style="width:100px;height:200px; margin-left：20px;"
                />
                <img
                  src="../assets/zhifu2.png"
                  style="width:100px;height:200px; margin-left：20px;"
                />
                <img
                  src="../assets/zhifu3.png"
                  style="width:100px;height:200px; margin-left：20px;"
                />
              </div>
