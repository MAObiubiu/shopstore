<template>
    <div>
            ...
            <div class="filter stopPop" id="filter" v-bind:class="{'filterby-show':filterBy}">
              <dl class="filter-price">
                ...
                <dd v-for="(item,index) in priceFilter" v-bind:key="index">
                  <a href="javascript:void(0)" @click="setPriceFilter(index)" v-bind:class="{'cur':priceChecked==index}">{{item.fenlei}}</a>
                </dd>
              </dl>
            </div>
              ...
              <div class="accessory-list col-4">
                <ul>
                  <li v-for="(item,index) in goodsList" v-bind:key="index">
                    <div class="pic">
                      <a href="#"><img v-lazy="require('./../assets/'+item.productImage)" alt=""></a>
                    </div>
                    <div class="main">
      ...
      <modal v-bind:mdShow="mdShowCart" v-on:close="closeModal">
        ...
        <div slot="btnGroup">
          <a class="btn btn--m" href="javascript:;" @click="mdShowCart = false" style="width:60px">继续购物</a>
          <router-link class="btn btn--m btn--red" href="javascript:;" to="/xiangqing" style="width:60px">商品详情</router-link>
          <router-link class="btn btn--m btn--red" href="javascript:;" to="/cart" style="width:60px">查看购物车</router-link>
        </div>
      </modal>
